...
import net.iubris.jbbp.dao.base.Committable;
import net.iubris.jbbp.dao.base.DAO;
...
public class PersisterTransactionable<K, V> implements DAO<K, V, V, Boolean, Boolean>, Committable {
	...
	public PersisterTransactionable(BerkeleyDBHelper<K, V> berkeleyDBHelper, Class<K> keyClass, Class<V> valueClass ) {
