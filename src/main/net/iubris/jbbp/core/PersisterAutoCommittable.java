...
public class PersisterAutoCommittable<K, V> implements DAO<K, V, V, Boolean, Boolean> {
	...
	public PersisterAutoCommittable(BerkeleyDBHelper<K, V> berkeleyDBHelper, Class<K> keyClass, Class<V> valueClass ) {
...
//		throw new ExistantValueException();
	...
	public Boolean remove(K key) {
		return primaryIndex.delete(key);
	}
